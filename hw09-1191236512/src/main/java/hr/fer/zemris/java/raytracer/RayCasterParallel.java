...
public class RayCasterParallel {
	...
	public static class RaytracerJob extends RecursiveAction {
		...
		protected void compute() {
			...
			invokeAll(
				new RaytracerJob(eye, view, viewUp, horizontal, vertical, width, height, requestNo, observer, cancel, red, green, blue, yMin, yMin + (yMax - yMin) / 2),
				new RaytracerJob(eye, view, viewUp, horizontal, vertical, width, height, requestNo, observer, cancel, red, green, blue, yMin + (yMax - yMin) / 2, yMax)
			);
		}
	...
	private static IRayTracerProducer getIRayTracerProducer() {
		return new IRayTracerProducer() {
			...
			public void produce(Point3D eye, Point3D view, Point3D viewUp,
				...
				pool.invoke(new RaytracerJob(eye, view, viewUp, horizontal, vertical, width, height, requestNo, observer, cancel, red, green, blue, 0, height));
				pool.shutdown();
